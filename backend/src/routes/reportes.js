...
const {totalCosecha, cosechaMensual, porCalidad, mejorCultivo, porFecha, generarPDF, reportePorFinca} = require('../controllers/reportesController');
...
router.get('/por-finca',      verificarToken, adminOEmpleado, reportePorFinca);
